...
public interface IToggleProvider extends IInitable {
	...
	class ToggleProviderContext {
		...
		public ToggleProviderContext(IInitContext init, IToggleProvider toggleProvider) {
			ToggleState = init.addProperty(StandardPropertyIds.UIA_ToggleToggleStatePropertyId, toggleProvider::get_ToggleState, StandardVariantConverters.I4_INativeEnum(at.bestsolution.uia.javafx.uia.ToggleState::fromNativeValue));
		}
	}
