...
public interface ITableProvider extends IInitable {
	...
	class TableProviderContext {
		...
		public TableProviderContext(IInitContext init, ITableProvider tableProvider) {
			RowOrColumnMajor = init.addProperty(StandardPropertyIds.UIA_TableRowOrColumnMajorPropertyId, tableProvider::get_RowOrColumnMajor, StandardVariantConverters.I4_INativeEnum(at.bestsolution.uia.javafx.uia.RowOrColumnMajor::fromNativeValue));
