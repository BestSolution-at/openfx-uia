...
public interface IDockProvider extends IInitable {
	...
	class DockProviderContext {
		...
		public DockProviderContext(IInitContext init, IDockProvider provider) {
			DockPosition = init.addProperty(StandardPropertyIds.UIA_ToggleToggleStatePropertyId, provider::get_DockPosition, StandardVariantConverters.I4_INativeEnum(at.bestsolution.uia.javafx.uia.DockPosition::fromNativeValue));
		}
	}
