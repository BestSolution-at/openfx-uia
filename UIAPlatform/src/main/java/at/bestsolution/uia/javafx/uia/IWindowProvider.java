...
public interface IWindowProvider extends IInitable {
	...
	class WindowProviderContext {
		...
		public WindowProviderContext(IInitContext init, IWindowProvider windowProvider) {
			...
			WindowVisualState = init.addProperty(StandardPropertyIds.UIA_WindowWindowVisualStatePropertyId, windowProvider::get_WindowVisualState, StandardVariantConverters.I4_INativeEnum(at.bestsolution.uia.javafx.uia.WindowVisualState::fromNativeValue));
			WindowInteractionState = init.addProperty(StandardPropertyIds.UIA_WindowWindowInteractionStatePropertyId, windowProvider::get_WindowInteractionState, StandardVariantConverters.I4_INativeEnum(at.bestsolution.uia.javafx.uia.WindowInteractionState::fromNativeValue));
