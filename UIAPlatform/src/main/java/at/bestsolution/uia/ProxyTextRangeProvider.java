...
import at.bestsolution.uia.glass.WinTextRangeProvider;
import at.bestsolution.uia.provider.Convert;
import at.bestsolution.uia.winapi.Windows;

import at.bestsolution.uia.javafx.uia.ITextAttribute;
import at.bestsolution.uia.javafx.uia.ITextAttributeId;
import at.bestsolution.uia.javafx.uia.ITextAttributeSupport;
import at.bestsolution.uia.javafx.uia.ITextRangeProvider;
import at.bestsolution.uia.javafx.uia.ITextRangeProvider2;
import at.bestsolution.uia.javafx.uia.IUIAElement;
import at.bestsolution.uia.javafx.uia.IUIAVirtualRootElement;
import at.bestsolution.uia.javafx.uia.IVariantConverter;
...
public class ProxyTextRangeProvider {
  ...
  private static final Logger LOG = LoggerFactory.create(ProxyTextRangeProvider.class);
    ...
    private Map<ITextAttributeId, at.bestsolution.uia.javafx.uia.FindAttribute<Object>> findAttributes = new HashMap<>();

    @SuppressWarnings("unchecked")
    private ITextAttributeSupport support = new ITextAttributeSupport(){

        @Override
        public <T> ITextAttribute<T> addAttribute(ITextAttributeId id, Supplier<TextAttributeValue<T>> getter, IVariantConverter<T> converter, at.bestsolution.uia.javafx.uia.FindAttribute<T> findAttribute) {
            ...
            if (findAttribute != null) {
                findAttributes.put(id, (at.bestsolution.uia.javafx.uia.FindAttribute<Object>) findAttribute);
            }
            return null;
        }
        ...
        return guardLong(() -> {
          return InstanceTracker.withReason("ITextRangeProvider_FindAttribute", () -> {
            ...
            if (this.isUIA()) {
                ...
                at.bestsolution.uia.javafx.uia.FindAttribute<Object> findAttribute = findAttributes.get(id);
                if (findAttribute != null) {
