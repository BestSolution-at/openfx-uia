...
//    }
    ...
    public WinAccessible8(ProxyAccessible proxy) {
        this.proxy = proxy;
                ...
                if (expanded != null) {
                    ...
                    if (getAttribute(ROLE) == AccessibleRole.TREE_TABLE_ROW) {
                        ...
                        if (treeTableView != null && rowIndex != null) {
                            ...
                            if (node != null) {
                                long ptr = ((WinAccessible8)getAccessible(node)).getNativeAccessible();
    ...
    private List<Node> getUnignoredChildren(WinAccessible8 acc) {
...
//                    }
    ...
    public long get_FragmentRoot() {
        ...
        WinAccessible8 acc = (WinAccessible8)getAccessible(scene);
    ...
    private long NavigateListView(WinAccessible8 listItemAccessible, int direction) {
        ...
        switch (direction) {
            case NavigateDirection_Parent: {
                ...
                if (treeCell) {
                    ...
                    if (node == null) {
                        /* root tree item case*/
                        WinAccessible8 acc = (WinAccessible8)getContainer();
            ...
            case NavigateDirection_PreviousSibling: {
                 ...
                 */
                if (parent != null) {
                    WinAccessible8 parentAccessible = (WinAccessible8)getAccessible(parent);
            ...
            case NavigateDirection_LastChild: {
                ...
                if (role == AccessibleRole.TREE_VIEW) {
                    ...
                    if (node != null) {
                        ...
                        if (role == AccessibleRole.LIST_ITEM) {
                            WinAccessible8 itemAcc = (WinAccessible8)getAccessible(node);
    ...
    public long[] GetSelection() {
        ...
        switch (role) {
            ...
            case TEXT_FIELD:
            case TEXT_AREA: {
                ProxyTextRangeProvider selectionRange = ProxyTextRangeProvider.wrap(proxy, new WinTextRangeProvider8(this));
    ...
    public long RangeFromPoint(double x, double y) {
        ...
        if (offset != null) {
            WinTextRangeProvider8 range = new WinTextRangeProvider8(this);
    ...
    public long get_DocumentRange() {
        ...
        ProxyTextRangeProvider documentRange = ProxyTextRangeProvider.wrap(proxy, new WinTextRangeProvider8(this));
