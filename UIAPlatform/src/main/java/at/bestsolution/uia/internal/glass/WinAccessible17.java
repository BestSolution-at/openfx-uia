...
public final class WinAccessible17 extends Accessible implements IWinAccessible {
                ...
                if (expanded != null) {
                    ...
                    if (getAttribute(ROLE) == AccessibleRole.TREE_TABLE_ROW) {
                        ...
                        if (treeTableView != null && rowIndex != null) {
                            ...
                            if (node != null) {
                                long ptr = ((WinAccessible17)getAccessible(node)).getNativeAccessible();
    ...
    private List<Node> getUnignoredChildren(WinAccessible17 acc) {
...
//                    }
    ...
    public long get_FragmentRoot() {
        ...
        WinAccessible17 acc = (WinAccessible17)getAccessible(scene);
    ...
    private long NavigateListView(WinAccessible17 listItemAccessible, int direction) {
        ...
        switch (direction) {
            case NavigateDirection_Parent: {
                ...
                if (treeCell) {
                    ...
                    if (node == null) {
                        /* root tree item case*/
                        WinAccessible17 acc = (WinAccessible17)getContainer();
            ...
            case NavigateDirection_PreviousSibling: {
                ...
                /*
                    ...
                    */
                if (parent != null) {
                    WinAccessible17 parentAccessible = (WinAccessible17)getAccessible(parent);
            ...
            case NavigateDirection_LastChild: {
                ...
                if (role == AccessibleRole.TREE_VIEW) {
                    ...
                    if (node != null) {
                        ...
                        if (role == AccessibleRole.LIST_ITEM) {
                            WinAccessible17 itemAcc = (WinAccessible17)getAccessible(node);
    ...
    public long RangeFromPoint(double x, double y) {
        ...
        if (offset != null) {
            WinTextRangeProvider17 range = new WinTextRangeProvider17(this);
