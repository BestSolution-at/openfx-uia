...
final class WinApplication extends Application implements InvokeLaterDispatcher.InvokeLaterSubmitter {
    ...
    WinApplication() {
        System.out.println("PATCHED WinApplication: constructor.");
    ...
    @Override public Accessible createAccessible() {
        System.out.println("PATCHED WinApplication: createAccessible() was called");
        ...
        //     java.lang.reflect.Method m = cls.getMethod("createAccessible", args);
        //     java.lang.Object[] invoke_args = {};
        //     return (com.sun.glass.ui.Accessible) m.invoke(null, invoke_args);
        // } catch (Throwable t) {
        //     throw new java.lang.RuntimeException(t);
        // }
        // create ProxyAccessible via reflection
        try {
            java.lang.ClassLoader loader = java.lang.ClassLoader.getSystemClassLoader();
            java.lang.Class cls = loader.loadClass("at.bestsolution.uia.internal.ProxyAccessible");
            return (com.sun.glass.ui.Accessible) cls.getDeclaredConstructor().newInstance();
        } catch (Throwable t) {
            throw new java.lang.RuntimeException(t);
        }
        // direct code
        // return at.bestsolution.uia.core.AccessibleFactory.createAccessible();
        // return new at.bestsolution.uia.internal.ProxyAccessible();
    }
